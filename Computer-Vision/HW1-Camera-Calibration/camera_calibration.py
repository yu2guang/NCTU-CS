...
from calibration_yuen import calibration
...
objp_np = np.array(objpoints)
imgp_np = np.array(imgpoints).reshape(-1,corner_x*corner_y,2)

mtx, extrinsics = calibration(objp_np, imgp_np, objp_np.shape[0])
